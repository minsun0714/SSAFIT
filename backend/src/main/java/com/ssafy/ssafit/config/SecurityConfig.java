    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/members/*", "/api/video/search", "/api/video/search/autocomplete", "/api/reviews/*", "/api/likes/list/*", "/api/exercise-log/grass/*", "/api/follows/*").permitAll()
